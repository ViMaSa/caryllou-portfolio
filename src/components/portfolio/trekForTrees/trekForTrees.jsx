  ...
  return (
    <>
      <main className="project-main">
        <p className="project-number slide-right">03</p>
        <div className="project-heading-line slide-left" />
        <p className="project-title slide-right">Trek For Trees</p>
        <div className="project-heading-line slide-left" />
      ...
      <FooterLinks
        leftLinkPath = "/portfolio/colliers"
        leftLinkText = "<< 02. Colliers"
        rightLinkPath = "/portfolio/life-aquatic"
        rightLinkText = "04. Life Aquatic >>"
      />
    </>
  )
}
