  ...
  return (
    <>
      <main className="project-main">
        <p className="project-number slide-right">02</p>
        <div className="project-heading-line slide-left" />
        <p className="project-title slide-right">Colliers</p>
        <div className="project-heading-line slide-left" />
      ...
      <FooterLinks
        leftLinkPath = "/portfolio/digital-journal"
        leftLinkText = "<< 01. Digital Journal"
        rightLinkPath = "/portfolio/trek-for-trees"
        rightLinkText = "03. Trek for Trees >>"
      />
    </>
  )
}
